						...
						<div>
							<div className="flex border-b mb-6">
								<button
									...
									className={`px-6 py-3 text-sm font-medium transition-colors border-b-2 ${activeTab === 'description'
								...
								<button
									...
									className={`px-6 py-3 text-sm font-medium transition-colors border-b-2 ${activeTab === 'caracteristiques'
											? 'border-primary text-primary'
											: 'border-transparent text-gray-600 hover:text-gray-900'
										}`}
								>
								...
								<button
									...
									className={`px-6 py-3 text-sm font-medium transition-colors border-b-2 ${activeTab === 'dimensions'
											? 'border-primary text-primary'
											: 'border-transparent text-gray-600 hover:text-gray-900'
										}`}
								>
							...
							<div className="space-y-6">
								...
								{activeTab === 'caracteristiques' && (
									<div className="space-y-4">
										...
										{/* Vitrage spécifique */}
										{fenetre.vitrage && (
											<div className="mt-4 p-4 bg-sky-50 border border-sky-200">
												<div className="flex items-center gap-2 mb-2">
