...
const PLANNING = [
  { semaine: "S1",  publie: true,  theme: "Matériaux",           titre: "PVC, Bois ou Alu ? Quel matériau choisir pour vos fenêtres à Bordeaux ?",                                    intention: "Transactionnelle" },
  { semaine: "S2",  publie: true,  theme: "Performance",          titre: "L'indice Uw et Sw : Tout comprendre sur l'isolation thermique de vos menuiseries.",                           intention: "Éducationnel" },
  ...
  { semaine: "S4",  publie: true,  theme: "Local (Climat)",       titre: "Fenêtres résistantes aux embruns : Le guide pour votre maison sur le Bassin d'Arcachon.",                     intention: "Locale/Spécifique" },
  { semaine: "S5",  publie: true,  theme: "Aides",                titre: "Ma Prime Rénov' et Menuiserie : Guide complet pour financer vos travaux de fenêtres.",                        intention: "Transactionnelle" },
  { semaine: "S6",  publie: true,  theme: "Double Vitrage",       titre: "Qu'est-ce que le Double Vitrage ? Les 3 erreurs à éviter lors du choix.",                                    intention: "Éducationnel" },
  ...
  { semaine: "S8",  publie: true,  theme: "La Pose",              titre: "Pose de Fenêtre : Pourquoi faire appel à un artisan professionnel plutôt qu'à un poseur seul ?",              intention: "Autorité/Confiance" },
  { semaine: "S9",  publie: true,  theme: "Tendance",             titre: "Les couleurs tendance pour les cadres de fenêtres en 2025 (pour l'architecture bordelaise).",                 intention: "Inspiration" },
  { semaine: "S10", publie: true,  theme: "Entretien",            titre: "Guide d'entretien pour les fenêtres ALU et PVC : 5 gestes pour une longévité maximale.",                      intention: "Entretien" },
