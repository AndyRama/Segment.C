...
| ✅ **+ 1 agent bonus** | Au choix | Variable | - |
...
|----------------|-------|-------------------|---------|-------------|
| **🔴 Gestion Contrats** | Commande & Acompte | Signature électronique du devis final contractuel - **BLOQUE la production sans signature** | 14 | ~420 € HT |
| **🔴 WhatsApp** | Suivi Client | Communication temps réel sur statut production/livraison - **Expérience client moderne** | 40 | ~1200 € HT |

**Total Agents Complémentaires : 54 Crédits (~1 620 € HT)**
...
### Option 2 : Pack Croissance + Agents Manquants ✅ (RECOMMANDÉ)

```yaml
Composition:
  - Pack Croissance: 1 999 € HT (9 agents)
  - Gestion Contrats: ~420 € HT
  - WhatsApp: ~1 200 € HT
...
### Option 3 : Agents à la Carte (Sans Pack)

```yaml
11 agents individuels: ~3 500 € HT
Économie Pack: 0%
Flexibilité: Maximale
```

**Résultat** : Coût similaire à l'Option 2, mais sans l'économie du pack groupé
...
| Élément | Prix HT |
|---------|---------|
| **Pack Croissance** (9 agents) | 1 999 € |
| **Agent Gestion Contrats** (14 crédits) | 420 € |
| **Agent WhatsApp** (40 crédits) | 1 200 € |
| **Intégration n8n** (workflows & connexions) | 800 € |
| **Paramétrage Dashboard Next.js** | 600 € |
| **Formation équipe** (2 sessions) | 400 € |
| **TOTAL SETUP** | **5 419 € HT** |

### Coûts Récurrents (Mensuels)

| Poste | Prix HT/mois |
|-------|--------------|
| Hébergement n8n (Cloud) | 29 € |
| API Calls & Data Storage | 50 € |
| Maintenance & Support (optionnel) | 150 € |
| **TOTAL MENSUEL** | **229 € HT** |
...
✅ **Formation équipe incluse (2 sessions)**  
...
// Hypothèses
const hypotheses = {
  chantiersMoyens: 8, // par mois
  panierMoyen: 8500, // euros
...
// ROI
const beneficeNet = 142 480 - 8 167 = 134 313 €
const roi = (134 313 / 8 167) * 100 = 1644%
```
...
**Bénéfice net estimé sur 12 mois : 134 313 € HT**  
**Retour sur Investissement : 1 644%**  
...
| 5 | Gestion Contrats | Signature électronique | 14 | ❌ **À ajouter** |
...
| 9 | WhatsApp | Messagerie instantanée | 40 | ❌ **À ajouter** |
| 10 | Chatbot Site Web | Support 24/7 | 30 | ✅ Oui |
| 11 | Agent Bonus | Au choix | Variable | ✅ Oui |
