...
export function ProcessStep({ step, title, description, color, showConnector = false }: ProcessStepProps) {
  return (
    <div className="relative group">
      ...
      <div className="relative rounded-2xl border-2 border-blue-200 dark:border-blue-800 bg-white dark:bg-slate-950 p-6 transition-all group-hover:border-transparent">
        <div className={cn(
      ...
      {showConnector && (
        <div className="absolute -right-4 top-1/2 hidden h-0.5 w-8 bg-gradient-to-r from-blue-300 to-indigo-300 dark:from-blue-700 dark:to-indigo-700 lg:block" />
      )}
    </div>
  );
}