...
const AvailableFormsSection = () => {
  ...
  return (
    <div className="bg-gray-50 py-6 border-t mt-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {forms.map((form) => (
            <button
              ...
              className={`relative p-6 bg-white border-2 rounded-md transition-all hover:border-green-500 group cursor-pointer ${
