...
const AvailableFormsSection = () => {
  ...
  const forms = [
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 120 180" className="w-full h-full">
          <rect x="10" y="10" width="100" height="160" fill="none" stroke="#22c55e" strokeWidth="2" />
          <line x1="60" y1="10" x2="60" y2="170" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <path d="M 85 80 Q 95 85 85 90" fill="none" stroke="#22c55e" strokeWidth="2" />
          <circle cx="90" cy="85" r="3" fill="#22c55e" />
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 180 180" className="w-full h-full">
          <rect x="10" y="10" width="160" height="160" fill="none" stroke="#22c55e" strokeWidth="2" />
          <line x1="90" y1="10" x2="90" y2="170" stroke="#22c55e" strokeWidth="2" />
          <line x1="50" y1="10" x2="50" y2="170" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <line x1="130" y1="10" x2="130" y2="170" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <path d="M 65 80 Q 75 85 65 90" fill="none" stroke="#22c55e" strokeWidth="2" />
          <path d="M 145 80 Q 155 85 145 90" fill="none" stroke="#22c55e" strokeWidth="2" />
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 180 200" className="w-full h-full">
          <rect x="10" y="10" width="160" height="180" fill="none" stroke="#22c55e" strokeWidth="2" />
          <line x1="90" y1="10" x2="90" y2="190" stroke="#22c55e" strokeWidth="2" />
          <line x1="10" y1="120" x2="170" y2="120" stroke="#22c55e" strokeWidth="2" />
          <line x1="50" y1="10" x2="50" y2="120" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <line x1="130" y1="10" x2="130" y2="120" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <path d="M 65 55 Q 75 60 65 65" fill="none" stroke="#22c55e" strokeWidth="2" />
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 120 200" className="w-full h-full">
          <rect x="10" y="10" width="100" height="180" fill="none" stroke="#22c55e" strokeWidth="2" />
          <line x1="60" y1="10" x2="60" y2="190" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <line x1="10" y1="100" x2="110" y2="100" stroke="#22c55e" strokeWidth="2" />
          <path d="M 85 80 Q 95 85 85 90" fill="none" stroke="#22c55e" strokeWidth="2" />
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 120 200" className="w-full h-full">
          <rect x="10" y="10" width="100" height="180" fill="none" stroke="#22c55e" strokeWidth="2" />
          <line x1="10" y1="130" x2="110" y2="130" stroke="#22c55e" strokeWidth="2" />
          <line x1="60" y1="10" x2="60" y2="130" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <path d="M 85 60 Q 95 65 85 70" fill="none" stroke="#22c55e" strokeWidth="2" />
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 120 200" className="w-full h-full">
          <rect x="10" y="10" width="100" height="180" fill="none" stroke="#22c55e" strokeWidth="2" />
          <line x1="60" y1="10" x2="60" y2="190" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <path d="M 85 90 Q 95 95 85 100" fill="none" stroke="#22c55e" strokeWidth="2" />
          <path d="M 60 50 L 70 55 L 60 60" fill="#22c55e" />
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 180 200" className="w-full h-full">
          <rect x="10" y="10" width="160" height="180" fill="none" stroke="#22c55e" strokeWidth="2" />
          <line x1="90" y1="10" x2="90" y2="190" stroke="#22c55e" strokeWidth="2" />
          <line x1="50" y1="10" x2="50" y2="190" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <line x1="130" y1="10" x2="130" y2="190" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <path d="M 65 90 Q 75 95 65 100" fill="none" stroke="#22c55e" strokeWidth="2" />
          <path d="M 115 90 L 105 95 L 115 100" fill="none" stroke="#22c55e" strokeWidth="2" />
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 180 200" className="w-full h-full">
          ...
          <line x1="50" y1="10" x2="50" y2="190" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <line x1="130" y1="10" x2="130" y2="190" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="3,3" />
          <path d="M 50 50 L 60 55 L 50 60" fill="#22c55e" />
          <path d="M 130 50 L 140 55 L 130 60" fill="#22c55e" />
        </svg>
      )
    }
  ];
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {forms.map((form) => (
            <button
              ...
              className={`relative p-6 bg-white border-2 rounded-md transition-all hover:border-green-500 group ${
