...
export const saintJeanDIllacData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Saint-Jean-d'Illac, commune dynamique de Bordeaux Métropole, allie charme rural et proximité urbaine. Segment C Menuiserie intervient rapidement pour tous vos travaux de menuiserie, des pavillons résidentiels aux projets commerciaux.",
...
export const capFerretData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Cap Ferret, presqu'île emblématique du bassin d'Arcachon, mérite des menuiseries à la hauteur de son charme unique. Segment C Menuiserie intervient pour préserver et sublimer l'architecture typique des villas du Cap.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
...
export const merignacData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Mérignac, deuxième ville de la métropole bordelaise, offre un cadre de vie dynamique entre quartiers résidentiels et zones d'activités. Segment C Menuiserie accompagne particuliers et professionnels dans tous leurs projets de menuiserie.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
...
export const bordeauxData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Bordeaux, capitale mondiale du vin et ville au patrimoine UNESCO, exige des menuiseries à la hauteur de son architecture exceptionnelle. Segment C Menuiserie allie tradition et modernité pour sublimer votre patrimoine.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
...
export const bouscatData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Le Bouscat, ville résidentielle recherchée de la métropole bordelaise, séduit par son cadre de vie privilégié. Segment C Menuiserie répond aux attentes élevées des propriétaires avec des menuiseries haut de gamme.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
...
export const talenceData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Talence, ville universitaire et résidentielle au sud de Bordeaux, bénéficie d'un patrimoine architectural varié. Segment C Menuiserie intervient pour tous vos projets, de la rénovation à la construction neuve.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
  ...
  about: {
    title: "Propriétaires et bailleurs : des solutions adaptées à chaque budget",
    description: "Talence est diverse, mes solutions le sont aussi. Vous êtes propriétaire et cherchez à améliorer votre confort ? Bailleur souhaitant valoriser votre patrimoine locatif ? Parent d'étudiant voulant sécuriser son logement ? J'ai la réponse. Pas de superflu, que l'essentiel : des menuiseries performantes, durables et esthétiques, à des tarifs honnêtes. Mon crédo : la qualité accessible, sans compromis sur les finitions ni sur les matériaux.",
  },
  service: {
    city: 'Talence',
...
export const pessacData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Pessac, troisième ville de la métropole bordelaise, conjugue modernité et tradition viticole. Segment C Menuiserie accompagne l'essor de cette ville dynamique avec des menuiseries innovantes et performantes.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
  ...
  about: {
    title: "Innovation et durabilité : l'avenir de la menuiserie à Pessac",
    description: "Pessac bouge, ma menuiserie aussi. Matériaux biosourcés, triple vitrage nouvelle génération, systèmes d'ouverture intelligents : j'intègre les innovations qui ont du sens. De la Cité Frugès classée aux écoquartiers modernes, je maîtrise tous les défis techniques. Votre projet mérite des solutions à la fois écologiques et performantes. Mon objectif : créer des menuiseries qui réduisent votre empreinte carbone tout en améliorant votre confort au quotidien.",
  },
  service: {
    city: 'Pessac',
...
export const cestasData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Cestas, plus grande commune de la métropole bordelaise, offre un cadre de vie privilégié en lisière de forêt. Segment C Menuiserie intervient pour sublimer vos projets résidentiels dans cet environnement naturel exceptionnel.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
  ...
  about: {
    title: "Vivre en lisière de forêt : menuiseries qui dialoguent avec la nature",
    description: "À Cestas, la forêt est partout. Vos menuiseries doivent créer ce lien unique entre intérieur et extérieur. J'adore ces projets où les grandes baies vitrées ouvrent sur les pins, où le bois noble prolonge la nature à l'intérieur. Mais attention : qui dit proximité de forêt dit aussi humidité, insectes, variations thermiques. Je sélectionne des essences durables et des traitements adaptés. Résultat : des menuiseries belles, saines et pérennes qui magnifient votre cadre de vie forestier.",
  },
  service: {
    city: 'Cestas',
...
export const gradignanData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Gradignan, ville verte au sud de Bordeaux, séduit par son cadre de vie préservé. Segment C Menuiserie propose des menuiseries haut de gamme en harmonie avec le caractère résidentiel de la commune.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
...
export const arcachonData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Arcachon, perle du bassin éponyme, célèbre pour ses villas et sa dune du Pilat, mérite des menuiseries exceptionnelles. Segment C Menuiserie préserve et magnifie l'architecture balnéaire arcachonnaise.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
...
export const laTesteData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "La Teste-de-Buch, plus grande commune de Gironde, s'étend du bassin d'Arcachon à la forêt landaise. Segment C Menuiserie accompagne le développement de cette ville dynamique avec des solutions adaptées à chaque quartier.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
  ...
  about: {
    title: "Du port à la dune : une expertise polyvalente pour La Teste",
    description: "La Teste, c'est tout un territoire ! Des cabanes ostréicoles du port aux villas face à la dune, des pavillons de Cazaux aux commerces touristiques : chaque secteur a ses besoins spécifiques. Cette diversité fait ma richesse professionnelle. Je connais les contraintes marines, les défis de l'habitat permanent, les exigences du tertiaire. Quel que soit votre projet, j'ai l'expérience et les solutions techniques pour le mener à bien avec efficacité.",
  },
  service: {
    city: 'La Teste-de-Buch',
...
export const andernosData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Andernos-les-Bains, station balnéaire familiale sur la rive nord du bassin, charme par son authenticité. Segment C Menuiserie propose des menuiseries adaptées au caractère balnéaire et forestier de la commune.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
...
export const biganosData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Biganos, porte d'entrée du bassin d'Arcachon, conjugue tradition ostréicole et développement résidentiel. Segment C Menuiserie accompagne l'essor de cette commune avec des menuiseries performantes et durables.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
  ...
  about: {
    title: "Votre artisan de proximité : réactivité et transparence",
    description: "À Biganos, je suis l'artisan du coin, celui qu'on recommande à ses voisins. Pourquoi ? Parce que je suis disponible, réactif, et que je dis les choses clairement. Pas de jargon technique inutile, pas de mauvaises surprises sur le devis. Je vous explique ce qui est nécessaire, ce qui est conseillé, ce qui peut attendre. Construction neuve ou rénovation, particulier ou professionnel : je m'adapte à votre projet et à votre budget avec la même rigueur.",
  },
  service: {
    city: 'Biganos',
...
export const martignasData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Martignas-sur-Jalle, commune résidentielle de la métropole bordelaise, offre un cadre de vie agréable. Segment C Menuiserie intervient pour tous vos projets de menuiserie avec expertise et professionnalisme.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
...
export const saintMedardData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Saint-Médard-en-Jalles, ville dynamique au nord-ouest de Bordeaux, conjugue zones résidentielles et pôles d'activités. Segment C Menuiserie accompagne son développement avec des solutions innovantes et durables.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
  ...
  about: {
    title: "Du logement familial au local professionnel : un seul interlocuteur",
    description: "Saint-Médard grandit vite. Nouveaux quartiers, zones d'activités, réhabilitations : la ville bouge. Et moi avec elle ! Que vous soyez particulier en quête de confort ou professionnel cherchant une vitrine attractive, j'ai les compétences. Menuiseries certifiées coupe-feu pour les ERP, vitrages acoustiques pour les logements en zone bruyante, systèmes d'ouverture automatiques pour l'accessibilité : je maîtrise les normes et les solutions techniques pour chaque usage.",
  },
  service: {
    city: 'Saint-Médard-en-Jalles',
...
export const eysinesData: VilleData = {
  hero: {
    ...
    department: 'Gironde',
    departmentNumber: '33',
    description: "Eysines, commune en plein essor au nord-ouest de Bordeaux, offre un cadre de vie privilégié. Segment C Menuiserie accompagne les habitants d'Eysines dans tous leurs projets de menuiserie avec professionnalisme.",
    phoneNumber: '05 56 12 34 56',
    benefits: [
