...
export const saintJeanDIllacData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Moustiquaires et protections insectes",
      "Réparation et entretien menuiseries",
    ],
...
export const capFerretData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Stores extérieurs anti-UV",
      "Portails coulissants et battants",
      "Claustras bois et aluminium",
      "Entretien et traitement bois marine",
    ],
    founderName: "Rui De Carvalho",
    founderTitle: "Fondateur de Segment.C",
    founderPhone: "06 71 78 72 53",
...
export const bordeauxData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Portes cochères et portails patrimoniaux",
      "Volets battants traditionnels",
      "Verrières type atelier",
      "Diagnostic et expertise bâti ancien",
    ],
    founderName: "Rui De Carvalho",
    founderTitle: "Fondateur de Segment.C",
    founderPhone: "06 71 78 72 53",
...
export const bouscatData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Bibliothèques et menuiseries décoratives",
      "Home cinéma et isolation phonique",
    ],
    founderName: "Rui De Carvalho",
    founderTitle: "Fondateur de Segment.C",
    founderPhone: "06 71 78 72 53",
...
export const talenceData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Serrurerie et sécurisation",
      "Remplacement vitrage simple/double",
      "Solutions locatives durables",
    ],
    founderName: "Rui De Carvalho",
    founderTitle: "Fondateur de Segment.C",
    founderPhone: "06 71 78 72 53",
...
export const pessacData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Systèmes domotiques connectés",
      "Panneaux solaires intégrés",
      "Récupération eaux pluviales (goulottes)",
...
export const cestasData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Traitement anti-insectes xylophages",
      "Terrasses bois exotiques",
      "Abris de jardin sur mesure",
      "Carports et pergolas bois",
    ],
    founderName: "Rui De Carvalho",
    founderTitle: "Fondateur de Segment.C",
    founderPhone: "06 71 78 72 53",
...
export const gradignanData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Pool house et cabanes",
      "Garde-corps verre et inox",
      "Verrières d'intérieur style atelier",
      "Escaliers bois contemporains",
    ],
    founderName: "Rui De Carvalho",
    founderTitle: "Fondateur de Segment.C",
    founderPhone: "06 71 78 72 53",
...
export const arcachonData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Balustrades et garde-corps patrimoniaux",
      "Portes vitrées à petits carreaux",
      "Fenêtres cintrées sur mesure",
      "Coursives et galeries bois",
    ],
    founderName: "Rui De Carvalho",
    founderTitle: "Fondateur de Segment.C",
    founderPhone: "06 71 78 72 53",
...
export const laTesteData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Vitrines réfrigérées (restaurants)",
      "Portes coupe-feu commerciales",
      "Aménagements terrasses professionnelles",
      "Stores et protections solaires commerciales",
    ],
    founderName: "Rui De Carvalho",
    founderTitle: "Fondateur de Segment.C",
    founderPhone: "06 71 78 72 53",
...
export const andernosData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Systèmes anti-effraction résidences secondaires",
      "Volets automatisés connectés",
      "Portails motorisés avec visiophone",
...
export const martignasData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Audit énergétique menuiseries",
      "Remplacement menuiseries anciennes",
      "Baies vitrées à galandage",
      "Solutions ventilation intégrée",
    ],
    founderName: "Rui De Carvalho",
    founderTitle: "Fondateur de Segment.C",
    founderPhone: "06 71 78 72 53",
...
export const saintMedardData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Rénovation énergétique",
      "Portes coupe-feu",
      "Cloisons vitrées bureaux",
      "Portes automatiques PMR",
...
export const eysinesData: VilleData = {
  ...
  service: {
    ...
    services: [
      ...
      "Menuiseries mixtes",
      "Conseil conception architecturale",
      "Extensions bois et vérandas",
      "Claustra et séparations extérieures",
      "Coordonnées chantier multi-corps état",
    ],
    founderName: "Rui De Carvalho",
    founderTitle: "Fondateur de Segment.C",
    founderPhone: "06 71 78 72 53",
