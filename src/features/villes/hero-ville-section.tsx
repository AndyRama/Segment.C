      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
        ...
        <nav className="text-sm text-gray-500 mb-6" aria-label="Breadcrumb">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span>/</span>
            <Link href="/villes" className="hover:text-green-600 transition">
              Nos Villes
            </Link>
            <span>/</span>
        ...
        {/* Badge Location */}
        <div className="inline-flex items-center rounded-full bg-green-100 text-green-700 px-4 py-2 text-sm font-medium mb-6">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button 
                ...
                className="flex items-center justify-center bg-green-600 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:bg-green-700 transition"
              >
              ...
              <a 
                ...
                className="flex items-center justify-center bg-white border-2 border-gray-300 text-gray-800 font-semibold py-3 px-6 rounded-lg hover:border-green-500 transition"
              >
              ...
              <ul className="space-y-4 mb-6">
                {benefits.map((benefit, index) => (
                  <li key={index} className="flex items-start">
                    <div className="rounded-full bg-green-100 p-1 mr-3 mt-0.5 flex-shrink-0">
