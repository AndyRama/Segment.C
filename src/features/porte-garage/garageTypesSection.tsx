				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					{types.map((type) => (
						<button
							...
							className={`relative p-6 bg-white border-2 rounded-lg transition-all hover:border-green-500 group ${selectedType === type.id ? 'border-green-500 shadow-lg' : 'border-gray-200'
								}`}
						>
