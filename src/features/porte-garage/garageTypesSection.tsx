  ...
  const types = [
    {
      ...
      description: 'Ouverture verticale avec panneaux articulés. Gain de place optimal.',
      icon: (
    ...
    },
    {
      ...
      description: 'Un seul panneau qui bascule vers le haut. Solution économique et robuste.',
      icon: (
        <svg viewBox="0 0 200 180" className="w-full h-full">
          {/* Porte basculante */}
    ...
    },
    {
      ...
      description: "S'enroule dans un coffre. Gain de place maximal au plafond.",
      icon: (
        <svg viewBox="0 0 200 180" className="w-full h-full">
          {/* Coffre */}
    ...
    },
    {
      ...
      description: 'Coulisse latéralement le long du mur. Idéale pour plafond bas.',
      icon: (
        <svg viewBox="0 0 200 180" className="w-full h-full">
          {/* Panneau principal */}
    ...
    },
    {
      ...
      description: "Ouverture vers l'extérieur ou l'intérieur. Style traditionnel.",
      icon: (
        <svg viewBox="0 0 200 180" className="w-full h-full">
          {/* Vantail gauche */}
  ...
  return (
    <div className="bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {types.map((type) => (
            <button
              ...
              className={`relative p-6 bg-white border-2 rounded-lg transition-all hover:border-primary group ${
                selectedType === type.id ? 'border-primary shadow-lg' : 'border-gray-200'
              }`}
            >
        ...
        <div className="mt-8 p-6 bg-white border-2 border-primary/20 rounded-lg">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Nos experts vous conseillent gratuitement pour choisir le type de porte de garage 
                le mieux adapté à votre configuration : dimensions de l'ouverture, hauteur sous plafond, 
                dégagement latéral, et vos préférences d'utilisation.
              </p>
            </div>
          </div>
        </div>
