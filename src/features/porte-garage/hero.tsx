...
type PorteGarageHeroProps = {
  className?: string;
}

export default function PorteGarageHero({ className }: PorteGarageHeroProps) {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <Typography variant="p" className="text-muted-foreground leading-relaxed">
            Pratiques et fonctionnelles, nos portes de Garage sont conçues pour 
        ...
        <div className="relative">
          <div className="relative h-[400px] lg:h-[500px] rounded-lg overflow-hidden shadow-lg">
            <Image
              ...
              alt="Porte de garage moderne avec végétation"
              fill
