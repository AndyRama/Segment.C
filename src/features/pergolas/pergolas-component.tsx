...
const PergolaModal = ({
	...
	const getPerformanceIcon = (feature: string) => {
		if (feature.includes("Lames") || feature.includes("orientables")) return Wind;
		if (feature.includes("Protection") || feature.includes("solaire")) return Sun;
		if (feature.includes("Isolation") || feature.includes("thermique")) return Shield;
		if (feature.includes("météo") || feature.includes("automatique")) return Thermometer;
		if (feature.includes("Bois") || feature.includes("naturel")) return TreePine;
		if (feature.includes("Surface") || feature.includes("Grande")) return Home;
		if (feature.includes("Toiture") || feature.includes("Protection")) return Umbrella;
		return Shield;
	};
